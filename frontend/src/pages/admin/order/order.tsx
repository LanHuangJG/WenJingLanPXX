...
import {OrderModel} from "../../../model/OrderModel.tsx";
import axios from "axios";

export default function Order() {
    const [messageApi, contextHolder] = message.useMessage();
    const columns: TableProps<OrderModel>['columns'] = [
        {
            title: '订单ID',
            dataIndex: 'id',
            key: 'id',
        },
        {
            ...
            dataIndex: 'pic',
            key: 'pic',
            render: (pic) => <Image src={pic} className={"rounded select-none"}
    ...
    useEffect(() => {
        axios.get('/api/admin/order/getAll').then(res => {
